...
export default function HRDashboard() {
  ...
  const handleCreateJob = async (e) => {
    ...
    try {
      await api.post("/jobs", {
        ...jobForm,
        bonusAmount: Number(jobForm.bonusAmount),
      });
          ...
          <div>
            ...
            {loading ? (
              ...
              <div className="card text-muted">
                No jobs posted yet — create one on the left.
              </div>
            ) : (
                  ...
                  >
                    <div>
                      ...
                      <div className="text-muted" style={{ fontSize: 13 }}>
                        {job.department} · ₹{job.bonusAmount} bonus
                      </div>
                    </div>
                    <div className="flex gap-sm">
                      <button
                        className="btn btn-secondary btn-sm"
                        onClick={() => loadReferralsForJob(job)}
                      >
                        View Referrals
                      </button>
                      <button
                ...
                {referrals.map((ref, i) => (
                  ...
                  >
                    <div>
                      ...
                      <div className="text-muted" style={{ fontSize: 13 }}>
                        Referred by {ref.referredBy?.name || "Unknown"}
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <select
                        ...
                        value={ref.status}
                        onChange={(e) =>
                          handleStatusChange(ref._id, e.target.value)
                        }
                      >
                        <option value="submitted">Submitted</option>
                        <option value="under_review">Under Review</option>
